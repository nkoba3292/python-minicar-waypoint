...
v0.2: `02_IMUPLUS_togikai_sample_new_v0.1.py` からの初期コピー。
"""
import os
import sys
...
# File: 02_IMUPLUS_togikai_sample_new_v0.2.py
# Note: initial copy from v0.1 — update this header when modifying behavior.
